...
import { getReceiptConfig, saveReceiptConfig, DEFAULT_CONFIG } from '../../utils/receiptStorage.js';
...
export default function ReceiptSettings() {
  ...
  const handleSave = async () => {
    await saveReceiptConfig(config);
    setSaved(true);
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h2 className="text-2xl font-bold">ตั้งค่าใบกำกับภาษี</h2>
